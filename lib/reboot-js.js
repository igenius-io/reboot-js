...
function setupReboot(jsonConfigFile) {

    var rebootConfig = (jsonConfigFile) ? rebootUtilities.rbJsonFileSync(jsonConfigFile) : rebootUtilities.rbJsonFileSync(__dirname + '/reboot-config.json');
...
function go(jsonConfigFile) {

    //Setup reboot first
    setupReboot(jsonConfigFile);
